# -*- coding: utf-8 -*-
"""
Created on Mon Jun 27 19:36:02 2022
...
if __name__ == "__main__":
    ...
    # 读取ASTER GDEM遥感影像
    demgrid, proj, geotrans, row, column, band, type = read_img(r"E:\派森\期末\T4\new_dem.tif")
    oridata = demgrid
    # 为计算梯度给影像添加周围一圈数据
    ...
    slopeT = write_img(r"E:\派森\期末\T4\slope.tiff", tar_proj, geotrans, slope, type)
    aspectT = write_img(r"E:\派森\期末\T4\aspect.tiff", tar_proj, geotrans, aspect, type)
